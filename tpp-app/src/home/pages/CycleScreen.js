...
function PeriodNotification(props){
  return (
    <View style={[styles.periodNotifCard, styles.element]}>
      { props.daysTillPeriod > 0 && <Text style={styles.periodNotifText}> Your period might be coming within the next {props.daysTillPeriod} {props.daysTillPeriod === 1 ? "day" : "days"}.</Text> }
